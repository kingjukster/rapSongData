...
DATASET_DIR = "data/training/qwen3_4b_12line_section_mined_v4"
CONFIG_PATHS = {
    "full": CONFIG_DIR / "local_cuda_qwen3_4b_12line_section_v4_e1.json",
    "smoke": CONFIG_DIR / "local_cuda_qwen3_4b_12line_section_v4_smoke.json",
}
...
def test_v4_training_config_locks_v3_comparable_qlora_settings(kind: str) -> None:
    ...
    assert training["seed"] == training["data_seed"] == training["subset_shuffle_seed"] == 20260712
    ...
    assert "qwen3_4b_12line_section_v4" in training["tokenized_cache_dir"]


def test_v4_full_and_smoke_configs_have_safe_budgets_and_distinct_outputs() -> None:
